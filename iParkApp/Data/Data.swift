...
struct Data {
    static let spots = [
        ...
        ParkingItem(name: "ChargePoint Station", address: "1600 Holloway Ave., San Francisco", photoName: "ev", place: "Space 4", carLimit: 8, location: CLLocationCoordinate2D(latitude: 37.7157048, longitude: -122.4734916), fee: 4.0, hour: "0.0"),
